  ...
  <div class="container">
    <div class="align-items-center mb-3 row">
      <div class="col-lg-9 ms-auto me-auto">
        <h1 class="h1 mb-1 text-dark text-center">Daftar-daftar Product</h1>
        <p class="text-center">
      ...
      <div class="row">
        <div class="col-lg-3 col-sm-6">
          ...
          <h3 class="text-dark fw-normal pt-3">Product</h3>
          <p>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <h3 class="text-dark fw-normal pt-3">Calender</h3>
          <p>
            Quickly design and customize responsive mobile-first sites with Bootstrap, the world’s
            most popular front-end open source toolkit, featuring Sass variables and mixins,
            responsive grid system, extensive prebuilt components, and powerful JavaScript plugins.
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <h3 class="text-dark fw-normal pt-3">Camera</h3>
          <p>
            Quickly design and customize responsive mobile-first sites with Bootstrap, the world’s
            most popular front-end open source toolkit, featuring Sass variables and mixins,
            responsive grid system, extensive prebuilt components, and powerful JavaScript plugins.
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <h3 class="text-dark fw-normal pt-3">Miracast</h3>
          <p>
            Quickly design and customize responsive mobile-first sites with Bootstrap, the world’s
            most popular front-end open source toolkit, featuring Sass variables and mixins,
            responsive grid system, extensive prebuilt components, and powerful JavaScript plugins.
